									...
									<div class="col-md-2 col-sm-12 m-b-20">
										<div class="form-group"><label>Invoice Date</label>
											<div class="input-group">
												...
												<input  id='invdate' type="text" placeholder="Invoice Date" name="invoicedate" class="form-control datepicker-here inptFld_sz icn_sz_12" data-language='en' required>
											</div>
										</div>
									</div>
									<div class="col-md-2 col-sm-12 m-b-20">
										<div class="form-group"><label>Consumption Start Date</label>
											<div class="input-group">
												<span class="input-group-addon"><i class="icon-calendar"></i></span>
												<input id='startdate'  type="text" placeholder="Consumption Start Date" name="invoicestart" class="form-control datepicker-here inptFld_sz icn_sz_12" data-language='en' required>
											</div>
										</div>
									</div>
									<div class="col-md-2 col-sm-12 m-b-20">
										<div class="form-group"><label>Consumption End Date </label>
											<div class="input-group">
												<span class="input-group-addon"><i class="icon-calendar"></i></span>
												<input id='enddate' type="text" placeholder="Consumption End Date" name="invoiceend" required class="form-control datepicker-here inptFld_sz icn_sz_12" data-language='en'>
											</div>
										</div>
									</div>
