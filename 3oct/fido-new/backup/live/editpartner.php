                            ...
                            -->
                                ...
                                <div class="col-md-3 col-sm-6 marg_b_20">
									<div class="form-group">
										...
										<div class="input-group">
											...
											<input id='startdate' type="text" placeholder="Contract Start Date" name="contractstart" value="<?php echo  $sdate ?>"  class='form-control datepicker-here inptFld_sz' data-language='en'>
										</div>
									</div>
								</div>
                                ...
                                <div class="col-md-3 col-sm-6 marg_b_20">
									<div class="form-group">
										...
										<div class="input-group">
											<span class="input-group-addon"><i class="icon-calendar2"></i></span>
											<input  id='enddate' type="text" placeholder="Contract End Date" name="contractend" class="form-control datepicker-here inptFld_sz" value="<?php echo  $edate?>" data-language='en'>
										</div>
									</div>
								</div>
