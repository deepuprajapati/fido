...
<section class="info-contact" style="margin:70px 0">
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-4">
        ...
        <div class="office">
          <p><i class="fa fa-map-marker"></i> 377/17A Surya vihar 2 Sehatpur Faridabad (HR)</p>
          <p><i class="fa fa-phone"></i> (+91) 971 120 9206</p>
          <p><i class="fa fa-envelope"></i> info@nationalcargo.com </p>
