					...
					<div class="card card-inverse card-flat p-10 CrdTop_brdr">
						<div class="card-block p-b-50 p-0">
							<form name="Example" method="post">
                                ...
                                <div class="row">
									<div class="col-lg-5 col-md-12 col-sm-12 marg_b_20">
										<div class="form-group">
											<label>Select User:</label>
									...
									<div class="col-lg-2 addRmv_btn">
										
											<button type="Button" class="btn btn-primary" onClick="SelectMoveRows(document.Example.Features,document.Example.FeatureCodes,1)">Add <i class="icon-arrow-right32"></i></button>
											<button type="button" class="btn btn-primary" onClick="SelectMoveRows(document.Example.FeatureCodes,document.Example.Features,0)"><i class="icon-arrow-left32"></i> Remove</button>
