                        ...
                        <ul class="icons-list">
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                	<?php $x=1;
                                	foreach($res as $a=>$b){ ?>
                                	<a  target="_blank" href="<?php echo $config['SITE_URL']."/upload/upload_report_media/".$b['report']?>" class="dropdown-item"><i class="fa fa-external-link"></i>
                                	<?php if ($b['active']) {
                                		echo 'Report '.$x.' <i style="float: right;" class="fa fa-check icn_sz_20 text-success" aria-hidden="true"></i>';
                                	} else {
                                		echo 'Report '.$x.' <i style="float: right;" class="fa fa-times icn_sz_20 text-danger" aria-hidden="true"></i>';
                                	}
                                	 ?>
                                	 </a>
                                <?php $x++; } ?>
                                 <div class="dropdown-divider"></div>
                                    <a href="javascript:;" data-toggle="modal" onclick="f1(this)" data-target="#myyModal" class="dropdown-item"><i class="fa fa-upload"></i> Upload</a>
                                    <input type="hidden" value="<?php echo $projectData['id']; ?>" class="hval" >
                                </ul>
                            </li>
                        </ul>
