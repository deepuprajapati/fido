                                    ...
                                    <div class="col-lg-3 col-sm-6 p-l-0 p-r-0 br-grey-100 br-lg br-dashed resCode_dsh_cart">
                                        <div class="cardBx_dashbrd">
                                            <div class="col-md-12 col-12">
                                                ...
                                                <div class="x3 no-p no-m m-t-10 m-b-10 text-info"><span class="nojs_1"><?php echo count($project->selectallEstimateWithQuery('1'," and p.po_approvel = 1 and p.process = 0 ")); ?></span>
                                    ...
                                    <div class="col-lg-3 col-sm-6 p-l-0 p-r-0 br-grey-100 br-lg br-dashed resCode_dsh_cart">
                                        <div class="cardBx_dashbrd">
                                            <div class="col-md-12 col-12">
                                                ...
                                                <div class="x3 no-p no-m m-t-10 m-b-10 text-info"><span class="nojs_2"><?php echo count($project->selectallEstimateWithQuery('1'," and p.po_approvel !=1 "))?></span> <a href="<?php echo $config['SITE_URL']."globelServices.php?action=upcoming_project";?>" class="icnlnk_cards"><i class="icon-arrow-right42"></i></a></div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="procesBar_in_cart">
                                                    <div class="float-left" style="width:75%;padding-right: 7px;">
                                    ...
                                    <div class="col-lg-3 col-sm-6 p-l-0 p-r-0 br-grey-100 br-lg br-dashed resCode_dsh_cart">
                                        <div class="cardBx_dashbrd cardBx_dashbrd_mrg0">
                                            <div class="col-md-12 col-12">
                                                ...
                                                <div class="x3 no-p no-m m-t-10 m-b-10 text-info"><span class="nojs_3"><?php echo count($project->selectallEstimateWithQuery('1'," and p.process = 1 and p.reconciliation = 0 ")); ?></span>
                                    ...
                                    <div class="col-lg-3 col-sm-6 p-l-0 p-r-0 resCode_dsh_cart">
                                        <div class="cardBx_dashbrd cardBx_dashbrd_mrg0">
                                            <div class="col-md-12 col-12">
                                                ...
                                                <div class="x3 no-p no-m m-t-10 m-b-10 text-info"><span class="nojs_4"><?php echo count($project->selectallEstimateWithQuery('1'," and p.process = 1 and  p.reconciliation = 1 ")); ?></span>
            ...
            <div class="cstmRow cstmRow_flex resCodedashBrd_tbl">
                <div class="flx_cntWidth_45 p-0 bgWhite resCodeSng_cart">
                    ...
                    <div class="card card-inverse card-flat box_border_0">
                        ...
                        <!--<div class="card-block p-b-10">Basic table with <code>.table-bordered</code> class.</div>-->
                        <div class="table-responsive p-t-20 p-l-20 p-r-20">
