	...
	?>
		...
		<div class="col-md-6 col-sm-12">
			...
			<span class="input-group-addon"><i class="icon-calendar"></i></span>
			 <input type="text" class="form-control datepicker-here" name="Idate" id="Idate_picker" placeholder="YYYY-MM-DD" required data-language='en'>
			</div>
			</div>
		</div>
		<div class="col-md-6 col-sm-12">
		...
		<div class="col-md-6 col-sm-12">
			...
			<div class="input-group">
			<span class="input-group-addon"><i class="icon-calendar"></i></span>
			<input type="text" class="form-control datepicker-here" name="ISdate" id="" placeholder="YYYY-MM-DD" required data-language='en'>
			</div>
			</div>
		</div>
		<div class="col-md-6 col-sm-12">
			...
			<div class="input-group">
			<span class="input-group-addon"><i class="icon-calendar"></i></span>
			<input type="text" class="form-control datepicker-here" name="IEdate" id="" placeholder="YYYY-MM-DD" required data-language='en'>
			</div>
			</div>
		</div>
		</div>
...
if(isset($_POST['estimateNo']) && !empty($_POST['estimateNo'])) {
 ...
 $sql3="SELECT *, SUM(a.money) as m  FROM invoice_details as a, media_invoice as b where a.refId = b. id and b.campaignId = ".$est." group by a.refmediaId"; 
 ...
 ?>
	...
	<div class="row m-0 m-b-20 p-t-10" style=" background: #f4f4f494;">
		<div class="col-lg-3 col-md-12 col-sm-12 m-b-20">
			<div class="form-group select_srch"><label>Client Address</label>
			<textarea name="address" class="form-control icn_sz_12" rows="4" required=""><?php echo $clientinfo['official_address']." ".$clientinfo['state']." ".$clientinfo['country']." ".$clientinfo['postal_code']?></textarea>
			</div>
		</div>
		<div class="col-lg-3 col-md-12 col-sm-12 m-b-20">
			<div class="form-group select_srch"><label>Project Name</label>
				<div class="input-group">
					<input type="text" placeholder="Project Name" name="pname" class="form-control inptFld_sz icn_sz_12" required>
				</div>
			</div>
		</div>
		<div class="col-lg-2 col-md-12 col-sm-12 m-b-20">
			<div class="form-group select_srch"><label>Project Description</label>
				<textarea name="pdis" class="form-control icn_sz_12" rows="4" required=""></textarea>
			</div>
		</div>
		<div class="col-lg-2 col-md-12 col-sm-12 m-b-20">
			<div class="form-group select_srch"><label>Bank</label>
				<select class="form-control inptFld_sz icn_sz_12" name="bank" required="">
			   <option value="">Select Bank</option>
			   <?php
			   foreach ($Bankdetails as $key => $value) { ?>
				<option value="<?php echo $value['id'] ?>" <?php if($value['id'] == $bankinfo['id']) echo"selected"; ?>><?php echo $value['bank_name'] ?></option>
		...
		<div class="col-lg-2 col-md-12 col-sm-12 m-b-20">
			<div class="form-group select_srch"><label>PO No.</label>
				<div class="input-group">
					 <input name="invoicepo" class="form-control inptFld_sz icn_sz_12"  required="">
				</div>
			</div>
		</div>
	</div>
	...
	<div class="table-responsive m-b-20">
		<table class="table table-bordered manuMin_tbl_560">
			<thead>
				<tr class="bg-info">
					<th>Client Name	</th>
					<th>Project Name</th>
		...
		<div class="pdflinks">
			...
			?>
				...
				<!--<a target="_blank" href="<?php echo $config['SITE_URL']."invoicePDF.php?action=media&month=".$v['Invoice_month']."&id=".$est."&mid=".$v['id'];?>"><?php echo $v['projectName']?> </a><span><?php echo $v['Invoice_No']?></span>-->
				<a target="_blank" href="<?php echo $config['SITE_URL']."invoicePDF.php?action=media&month=".$v['Invoice_month']."&id=".$est."&mid=".$v['id'];?>" class="btn btn-primary btn-rounded btn-sm tooltip-top tooltip_cstm" data-tooltip="<?php echo $v['Invoice_No']?>"><i class="fa fa-file-pdf-o position-left"></i><?php echo $v['projectName']?></a>
				
			<?php } ?>	
			<?php } ?>	
		</div>
		<div class="row m-t-20">
			<div class="col-lg-3 col-md-6 col-sm-12 m-b-20">
				...
				<div class="input-group">
					<div class="input-group-addon">
						...
						<div class="chkbox_cstm_wpr">
							<div class="chbx_style m-0">
								<input type="checkbox" id="iscommision" class="shwInput icn_sz_12" name="iscommision" value="yes">
								<span></span>
							</div>
						</div>
						</label>
					</div>
					<input type="text" class="form-control inptFld_sz icn_sz_12" name="iscommision_val"  value="" placeholder="Others">
				</div>
			</div>
			<div class="col-lg-3 col-md-6 col-sm-12 m-b-20">
				<div class="form-group select_srch">
						<select class="form-control inptFld_sz icn_sz_12" name="iscommision_val_drop">
			...
			<div class="col-lg-3 col-md-6 col-sm-12 m-b-20">
				<div class="form-group select_srch">
					<div class="input-group">
						<span class="input-group-addon"><i class="icon-money-bag-2"></i></span>
						<input type="text" class="form-control inptFld_sz icn_sz_12" name="iscommision_money" value="" placeholder="Money">
					</div>
				</div>
			</div>
		</div>
		...
		<table class="table table-bordered table-striped manuMin_btmtbl_730">
		<thead>
			<tr>
				<th style="width:125px">Hide On invoice</th>
				<th>Publisher Name</th>
				<th>R.O. Amount</th>
				<th>Billed Amount</th>
				<th>Balance</th>
				<th style="min-width:207px">Current Amount</th>
				<th>Balance</th>
			</tr>
		</thead>
		<tbody>
		...
		<tr class="hide_on_commision">
			<td class="txt_cntr">
				<label class="marg_0">
					<div class="chkbox_cstm_wpr">
						<div class="chbx_style m-0">
							<input type="checkbox" id="iscommision" class="shwInput icn_sz_12" name="hide_on_invoice[<?php echo $v['id'] ?>]" value="yes">
							<span></span>
						</div>
					</div>
				</label>
			...
			<td class="maxamount"><?php
			 ...
			 ?></td>
			<td><input type="text" class="form-control icn_sz_12 inptFld_sz auto" name="money[<?php echo $v['id'] ?>]" onblur="checkbalance(this)" onkeypress='return event.charCode >= 48 && event.charCode <= 57' data-d-group="2"></td>
			<td class="bal"></td>
		</tr>
		<?php
		}
 ...
 if (isset($_GET['client_payment_show']) && !empty($_GET['client_payment_show'])) {
        ...
        ?>
           <tr class="<?php if($counter%2) { echo 'odd_tr_stl'; } else { echo 'evn_tr_stl'; } ?>">
            ...
            <td>
				...
				<input data-tr-no="trloop_<?= $counter; ?>" class="srchFld trloop_<?= $counter;?>" id="2" type="text" placeholder="Search..">
            </td>
            <td><p><?= @$mformate->currencyFormatCountry($value['billed'],$value['isIndian']);?></p><input data-tr-no="trloop_<?= $counter; ?>" class="srchFld trloop_<?= $counter;?>" id="3" type="text" placeholder="Search.."></td>
            <td><p><?= @$mformate->currencyFormatCountry($value['billed'] - $value['total'],$value['isIndian']);?></p><input data-tr-no="trloop_<?= $counter; ?>" class="srchFld trloop_<?= $counter;?>" id="4" type="text" placeholder="Search.."></td>
            <td><p><?= @$mformate->currencyFormatCountry($value['m'],$value['isIndian']);?></p><input data-tr-no="trloop_<?= $counter; ?>" class="srchFld trloop_<?= $counter;?>" id="5" type="text" placeholder="Search.."></td>
            <td><p><?= @$mformate->currencyFormatCountry($value['t'],$value['isIndian']);?></p><input data-tr-no="trloop_<?= $counter; ?>" class="srchFld trloop_<?= $counter;?>" id="6" type="text" placeholder="Search.."></td>
            <td><p><?= @$mformate->currencyFormatCountry($value['total'],$value['isIndian']);?></p><input data-tr-no="trloop_<?= $counter; ?>" class="srchFld trloop_<?= $counter;?>" id="7" type="text" placeholder="Search.."></td>
        </tr>
        <?php 
             $z = $value['cid'];
    ...
    <tr class="odd_tr_stl">
            ...
            <td>
				...
				<input data-tr-no="trloop_1" class="srchFld trloop_1" id="2" type="text" placeholder="Search..">
            </td>
            <td><?= @$mformate->currencyFormatCountry($payment_info_client[0]['billed'],$payment_info_client[0]['isIndian']);?><input data-tr-no="trloop_1" class="srchFld trloop_1" id="3" type="text" placeholder="Search.."></td>
            ...
            <td><?= @$mformate->currencyFormatCountry($payment_info_client[0]['m'],$payment_info_client[0]['isIndian']);?><input data-tr-no="trloop_1" class="srchFld trloop_1" id="5" type="text" placeholder="Search.."></td>
            <td><?= @$mformate->currencyFormatCountry($payment_info_client[0]['t'],$payment_info_client[0]['isIndian']);?><input data-tr-no="trloop_1" class="srchFld trloop_1" id="6" type="text" placeholder="Search.."></td>
            <td><?= @$mformate->currencyFormatCountry($payment_info_client[0]['total'],$payment_info_client[0]['isIndian']);?><input data-tr-no="trloop_1" class="srchFld trloop_1" id="7" type="text" placeholder="Search.."></td>
        </tr>
        <?php 
