  ...
  <div class="container">
    <div class="row">
      <div class="col-md-4">
		...
		<p>
		   <a href="http://localhost/www.packermover.com/" class="custom-logo-link" rel="home" itemprop="url"><img width="226" height="54" src="http://localhost/www.packermover.com/wp-content/uploads/2018/09/logo.png" class="custom-logo" alt="JMV" itemprop="logo"></a><br>
      ...
      <div class="col-sm-6 col-md-4">
        <aside class="widget widget_text">
          ...
          <div class="textwidget">
            <div class="office">
              <p><i class="fa fa-map-marker"></i> 377/17A Surya vihar 2 Sehatpur Faridabad
              </p>
              <p><i class="fa fa-phone"></i> (+91) 971 120 9206 </p>
