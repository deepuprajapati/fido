                        ...
                        <li class="dropdown">
                          ...
                          <ul class="dropdown-menu dropdown-menu-right" style="width:200px;">
                            ...
                            <div class="rightApp_btn">
                              <?php  if(hasPermission('Disapporve_Report',$permissioninfo) && $projectData['process']!= 1){ ?>
                              <a href="<?php echo $config['SITE_URL']."estimate.php?apporve_report=1&id=".$projectData['id'];?>" class="rprt_app">
                                <?php if ($b['active']) {
