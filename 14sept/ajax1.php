...
if(isset($_GET['action']) && $_GET['action']=='load_notification_green')
 ...
 if (isset($_GET['client_payment_show']) && !empty($_GET['client_payment_show'])) {
    ...
    if($a == 'all'){
        ...
        ?>
           <tr class="<?php if($counter%2) { echo 'odd_tr_stl'; } else { echo 'evn_tr_stl'; } ?>">
            ...
            <td><?= @$mformate->currencyFormatCountry($value['billed'],$value['isIndian']);?></td>
            <td><?= @$mformate->currencyFormatCountry($value['billed'] - $value['total'],$value['isIndian']);?></td>
            <td><?= @$mformate->currencyFormatCountry($value['m'],$value['isIndian']);?></td>
            <td><?= @$mformate->currencyFormatCountry($value['t'],$value['isIndian']);?></td>
            <td><?= @$mformate->currencyFormatCountry($value['total'],$value['isIndian']);?></td>
        </tr>
        <?php 
             $z = $value['cid'];
    ...
    <tr class="odd_tr_stl">
            ...
            <td><?= @$mformate->currencyFormatCountry($payment_info_client[0]['billed'],$payment_info_client[0]['isIndian']);?></td>
            <td><?= @$mformate->currencyFormatCountry($payment_info_client[0]['billed'] - $payment_info_client[0]['total'],$payment_info_client[0]['isIndian']);?></td>
            <td><?= @$mformate->currencyFormatCountry($payment_info_client[0]['m'],$payment_info_client[0]['isIndian']);?></td>
            <td><?= @$mformate->currencyFormatCountry($payment_info_client[0]['t'],$payment_info_client[0]['isIndian']);?></td>
            <td><?= @$mformate->currencyFormatCountry($payment_info_client[0]['total'],$payment_info_client[0]['isIndian']);?></td>
        </tr>
        <?php 
