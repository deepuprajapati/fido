...
$col="partner_id";
$val = $id;
		   $partner_cat_com->deleteCustom($col,$val);
		 if(!empty($_POST['mcomm']))
		   {
		   	   $partner_cat_com->id=$mValue[0]['id'];
			   $partner_cat_com->commision=trim($_POST['mcomm']);
			   $partner_cat_com->service_id=2;
			   $partner_cat_com->fee=0;
			   $partner_cat_com->totalFee= str_replace( ',', '', $_POST['Fee'] );
			   $partner_cat_com->partner_id=$id;
...
$sql = "INSERT INTO partner_section_commisions (commision, service_id, totalFee, fee, modified_on, partner_id )
    ...
    <!-- Page container begins -->
        <section class="main-container">
            ...
            <div class="container-fluid page-content">
                    ...
                    <div class="card-block p-b-50 p-0" >
						...
						<form role="form"  method='post'>  						
                            <div class="row">
                                ...
                                <div class="col-md-2 col-sm-6 marg_b_20">
                                    <div class="form-group">
										<label>Company Contract File</label>
										<ul class="icons-list marg_0">
										<li class="dropdown show marg_0">
                                ...
                                <div class="col-md-4 col-sm-6 marg_b_20">
                                    <div class="form-group">
                                ...
                                <div class="col-md-3 col-sm-6 marg_b_20">
									<div class="form-group">
										<label>Contract Start Date</label>
										<div class="input-group">
											<span class="input-group-addon"><i class="icon-calendar2"></i></span>
											<input id='startdate' type="text" placeholder="Contract Start Date" name="contractstart" value="<?php echo  $sdate ?>"  class='form-control datepicker-here inptFld_sz' data-language='en' required>
										</div>
									</div>
								</div>
                                ...
                                <div class="col-md-3 col-sm-6 marg_b_20">
									<div class="form-group">
										...
										<div class="input-group">
											<span class="input-group-addon"><i class="icon-calendar2"></i></span>
											<input  id='enddate' type="text" placeholder="Contract End Date" name="contractend" class="form-control datepicker-here inptFld_sz" value="<?php echo  $edate?>" data-language='en' required>
										</div>
									</div>
								</div>
                         ...
                         <div class="col-md-6">
							<div class="form-group">
								...
								<div class="input-group bootstrap-touchspin marg_b_20">
								  ...
								  } ?>" type="number" style="display: block;" disabled="disabled" onblur="getValue(this.value,this)" class="form-control" name="commsion_issued[<?php echo $p_cat['id']?>]" id="" placeholder="<?php echo $p_cat['name']?> Commission">
								  ...
								  } ?>" type="text" disabled="disabled" style="display: block;"  class="form-control auto" name="commsion_money[<?php echo $p_cat['id']?>]" placeholder="<?php echo $p_cat['name']?> Commission" readonly data-d-group="2">
				...
				<input style="display: block;" value="<?php foreach($comcat as $key=>$value1){ echo ($p_cat['id']==$key ? $value1[1] :''); } ?>" required="required" type="text" disabled="disabled"  class="form-control auto" name="commsion_money[<?php echo $p_cat['id']?>]" placeholder="<?php echo $p_cat['name']?> Commission" readonly data-d-group="2">
				 <span class="input-group-addon bootstrap-touchspin-postfix"><i class="icon icon-rupee"></i></span>
