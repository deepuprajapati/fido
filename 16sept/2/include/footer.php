  ...
  <div class="container">
    <div class="row">
      <div class="col-md-4">
		...
		<p>
		   <a href="http://localhost/www.packermover.com/" class="custom-logo-link" rel="home" itemprop="url">
		   <img width="226" height="54" src="images/logo.png" class="custom-logo" alt="JMV" itemprop="logo"></a><br>
        ...
        <div class="social-menu">
            <ul id="social-menu-footer" class="menu">
              ...
              <li class="menu-item">
                <a href="http://foursquare.com"><i class="fa fa-linkedin"></i></a></li>
            </ul>
          </div>
      </div>
