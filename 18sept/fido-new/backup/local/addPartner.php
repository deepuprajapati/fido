 ...
 //  $allLanguages = $language->getColumns();
   if(isset($_POST['company_name'])){
		   ...
		   $client_address->client_id = $last_insert_id;
   		   $client_address->state = trim($_POST['company_state']);
   		   $client_address->city = trim($_POST['company_district']);
   		   $client_address->picode = trim($_POST['company_pincode']);
   		   $client_address->address = trim($_POST['company_address']);
   		   $client_address->state_code = trim($_POST['state_code']);
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-sm-6 marg_b_20">
									...
									<div class="fromAppend_grp row marg_b_20 hide" id="bookTemplate">
										...
										<div class="col-md-1 p-r-0 p-l-0">
