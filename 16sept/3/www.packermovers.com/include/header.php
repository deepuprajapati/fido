...
<nav id="mobile-menu" class="mobilemenu">
    <ul>
  ...
  <li>
	<a href="core-value.php">CORE VIEW</a>
  </li>
  ...
  <li>
	<a href="our-services.php" >OUR SERVICES</a>
		  ...
		  <ul>
			<li><a href="home-shifting.php">Home Shifting</a></li>
			<li><a href="office-relocation-services.php">Office Relocation Services</a></li>
			<li><a href="long-short-term-storage.php">Long & Short-term Storage</a></li>
			<li><a href="vehicle-moving.php">Vehicle Moving</a></li>
			<li><a href="international-relocations.php">International Relocations</a></li>
			<li><a href="insurance-services.php">Insurance Services</a></li>
			<li><a href="home-assist.php">Home Assist</a></li>
			<li><a href="fine-art-move-experts.php">Fine Art Move Experts</a></li>
		  </ul>
  </li>
    ...
    <div class="row">
      <div class="col-xs-10 col-lg-2 site-branding">
        <a href="index.php" rel="home">
          <img src="images/logo.png" alt="Transport – Transport, Logistic &amp; Warehouse WP">
        </a>
      </div>
                ...
                <div class="contact-detail">
                  <div class="row">
                    <div class="col-md-4 col-xl-4 col-xl-offset-1">
                      ...
                      <h3>9711 209 206</h3>
                      <span>info@nationalcargo.in</span>
                    </div>
...
<nav class="navbar mega navbar-dark bg-dark hidden-lg-down">
  ...
  <li class="nav-item dropdown">
	<a class="nav-link" href="core-value.php">CORE VIEW</a>
  </li>

  <li class="nav-item dropdown mega-fw">
	<a href="our-services.php" class="nav-link rttAngl">OUR SERVICES</a>
	<div class="dropdown-menu" style="display:" >
	  <div class="mega-content megamenu_cstm">
		<div class="row">

		  <img class="mega-menu-img" src="images/menu-img.png" alt="Transport Menu Image">

		  <ul class="col-sm-8 col-sm-offset-3  list-unstyled megahrzl_menu">
			<li class="feature-list-item"><h6 class="feature-list-title"><a href="home-shifting.php">Home Shifting</a></h6></li>
			<li class="feature-list-item"><h6 class="feature-list-title"><a href="office-relocation-services.php">Office Relocation Services</a></h6></li>
			<li class="feature-list-item"><h6 class="feature-list-title"><a href="long-short-term-storage.php">Long & Short-term Storage</a></h6></li>
			<li class="feature-list-item"><h6 class="feature-list-title"><a href="vehicle-moving.php">Vehicle Moving</a></h6></li>
			<li class="feature-list-item"><h6 class="feature-list-title"><a href="international-relocations.php">International Relocations</a></h6></li>
			<li class="feature-list-item"><h6 class="feature-list-title"><a href="insurance-services.php">Insurance Services</a></h6></li>
			<li class="feature-list-item"><h6 class="feature-list-title"><a href="home-assist.php">Home Assist</a></h6></li>
			<li class="feature-list-item"><h6 class="feature-list-title"><a href="fine-art-move-experts.php">Fine Art Move Experts</a></h6></li>
		  </ul>
